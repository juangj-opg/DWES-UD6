<?php
// Ejercicio 1 - Clases y constructor
...
class Persona{
    ...
    {
        return "Nombre: ".$this->nombre."<br>DNI: ".$this->dni."<br>Sexo: ".$this->sexo."<br>Peso: ".$this->peso."<br>Altura: ".$this->altura;
    }

}

// Ejercicio 2 - Subclase
...
class Trabajador extends Persona{
    ...
    public function __toString()
    {
        return Persona::__toString()."<br>Empresa: ".$this->nombreEmpresa;
    }
